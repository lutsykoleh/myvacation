...
class __TwigTemplate_633b5c57bcae66bc756839973e79358f extends Template
{
    private $source;
    private $macros = [];
...
($context["menu_level"] ?? null) == 1) && twig_get_attribute($this->env, $this->source, $context["item"], "is_expanded", [], "any", false, false, true, 47))) {
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/dxpr_theme/templates/menu--main.html.twig", "/var/www/web/themes/contrib/dxpr_theme/templates/menu--main.html.twig");
    }
