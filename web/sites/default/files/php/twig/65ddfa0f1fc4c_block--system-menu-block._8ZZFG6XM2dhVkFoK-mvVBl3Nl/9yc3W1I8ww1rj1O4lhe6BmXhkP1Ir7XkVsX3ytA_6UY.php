...
class __TwigTemplate_74678fa3b8f403bcfdf617187b9acecc extends Template
{
    private $source;
    private $macros = [];
...
($context["theme"] ?? null), "settings", [], "any", false, false, true, 40), "block_well", [], "any", false, false, true, 40) && twig_in_filter(($context["region"] ?? null), ($context["designRegions"] ?? null)))) ? (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["theme"] ?? null), "settings", [], "any", false, false, true, 40), "block_well", [], "any", false, false, true, 40)) : (""))];
        // line 44
...
($context["theme"] ?? null), "settings", [], "any", false, false, true, 46), "title_well", [], "any", false, false, true, 46) && twig_in_filter(($context["region"] ?? null), ($context["designRegions"] ?? null)))) ? (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["theme"] ?? null), "settings", [], "any", false, false, true, 46), "title_well", [], "any", false, false, true, 46)) : (""))];
        // line 49
        echo "
<section";
        // line 50
...
";
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/dxpr_theme/templates/block--system-menu-block.html.twig", "/var/www/web/themes/contrib/dxpr_theme/templates/block--system-menu-block.html.twig");
    }
